...
▶️Tools I used 
1➡️Data
manipulation(python,numpy,pandas)
...
3️⃣Data preprocessing 
     ...
     3.4➡️Inserting time series columns to                data frame 
...
🔟 Deployment by flask .
 ...
 ▶️Eventually this is model performance  ...
      ...
      ▶️r2_score(0.991)        ▶️mean_absolute_percentage_error(0.092)
Here are the files take a look at it ..
https://github.com/nallamcharan/Sales-Forecasting-BY-ML-
#salesprediction #salesforecasting
#datascient #dataengineer #mlengineer
